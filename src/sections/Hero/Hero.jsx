  ...
  return (
    <div className="hero">
      ...
      <div className="hero-content">
        ...
        <Typography type="body" className="hero-subtitle">Based in the Timișoara, Romania. I’m a front-end developer passionate about building accessible web apps that users love.</Typography>
